...
•	Arguments:
o	fields: a list of strings representing all fields to obfuscate
o	redaction: a string representing by what the field will be obfuscated
o	message: a string representing the log line
o	separator: a string representing by which character is separating all fields in the log line (message)
